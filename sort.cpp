...
int main()
{
    ...
    cout << "1. Insertion Sort   2. Selection Sort\n3. Merge Sort       4.Radix Sort\n5. Bubble Sort      6. Quick Sort\n7. Heap Sort        28. Bucket Sort\n9. Shell Sort\nEnter 1/2/3/4/5/6/7/8/9: ";
    ...
    case 1:
        ...
        insertsort(arr, 10000);
        t = clock() - t;
        cout << "time taken for Worst case in insertion sort: " << (float)t / CLOCKS_PER_SEC << "\n \n"
             << endl;
    ...
    case 6:
        cout << "\nSize of Array : 10000" << endl;
        cout << "Best, Average and Worst Case for Quick sort" << endl;
        ...
        bubbleSort(arr, 10000);
        t = clock() - t;
        cout << "time taken for best case in Quick sort: " << (float)t / CLOCKS_PER_SEC << endl;
        ...
        bubbleSort(arr, 10000);
        t = clock() - t;
        cout << "time taken for Average case in Quick sort: " << (float)t / CLOCKS_PER_SEC << endl;
        ...
        bubbleSort(arr, 10000);
        t = clock() - t;
        cout << "time taken for Worst case in Quick sort: " << (float)t / CLOCKS_PER_SEC << endl;
        // End
        break;
        ...
        // Heap sort
         ...
         case 7:
        cout << "\nSize of Array : 10000" << endl;
        cout << "Best, Average and Worst Case for Heap sort" << endl;
        ...
        bubbleSort(arr, 10000);
        t = clock() - t;
        cout << "time taken for best case in Heap sort: " << (float)t / CLOCKS_PER_SEC << endl;
        ...
        // Bucket Sort
         case 8:
        cout << "\nSize of Array : 10000" << endl;
        cout << "Best, Average and Worst Case for Bucket sort" << endl;
        ...
        bubbleSort(arr, 10000);
        t = clock() - t;
        cout << "time taken for best case in Bucket sort: " << (float)t / CLOCKS_PER_SEC << endl;
        ...
        bubbleSort(arr, 10000);
        t = clock() - t;
        cout << "time taken for Average case in Bucket sort: " << (float)t / CLOCKS_PER_SEC << endl;
        ...
        bubbleSort(arr, 10000);
        t = clock() - t;
        cout << "time taken for Worst case in Bucket sort: " << (float)t / CLOCKS_PER_SEC << endl;
        // End
        break;
        // Shell Sort
         case 9:
        cout << "\nSize of Array : 10000" << endl;
        cout << "Best, Average and Worst Case for Shell sort" << endl;
        ...
        bubbleSort(arr, 10000);
        t = clock() - t;
        cout << "time taken for best case in Shell sort: " << (float)t / CLOCKS_PER_SEC << endl;
        ...
        bubbleSort(arr, 10000);
        t = clock() - t;
        cout << "time taken for Average case in Shell sort: " << (float)t / CLOCKS_PER_SEC << endl;
        ...
        bubbleSort(arr, 10000);
        t = clock() - t;
        cout << "time taken for Worst case in Shell sort: " << (float)t / CLOCKS_PER_SEC << endl;
        // End
        break;
    default:
